...
export default class Experiences extends Component {
    render() {
        const softwareEngineeringXps = this.props.data.softwareEngineering.map(
            (entry, i) => {
                ...
                const description = entry.description.map(
        ...
        return (
            <section>
                ...
                <div>
                    ...
                    <p className="summary">
                        Volunteer work ignited in me the caring for people: be
                        them the ones we are the doing the work for, or my
                        colleagues. It also taught me to value and dedicate my
                        time for something else than money, for something that
                        would do (or be) good for someone besides myself.
                    </p>

                    <p className="summary">
                        You can check my open source contributions at{' '}
                        <span className="org">
                            <a href="https://github.com/lfilho">
                                github.com/lfilho
                            </a>
                        </span>
                        .
