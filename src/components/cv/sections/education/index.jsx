...
export default class Education extends Component {
  render() {
    ...
    let otherEducation;
    const relevantCoursesTotalDuration = Math.round(education.relevantCourses.reduce((sum, entry) => sum + entry.duration, 0));
    ...
    if (!isVerbose) {
      ...
      otherEducation = (
        <>
          ...
          <div>
            Over {courseCount} courses and specializations taken, {bookCount} books read, {eventCount} events attended and{' '}
            {noteworthyCount} achievements on software engineering, entrepreneurship, leadership and self growth. See all of them
            at <a href=' /cv/verbose#relevant-courses'>luiz.dev/cv/verbose</a>.
          </div>
        </>
      );
    } else {
        ...
        <>
          <AnchoredHeader level='3' id='relevant-courses'>
            ...
            <small>
              ...
              {education.relevantCourses.length} courses on software, entrepreneurship, leadership and self development with a
