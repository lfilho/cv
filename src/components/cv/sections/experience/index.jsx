    ...
    if (!isVerbose) {
      ...
      otherXps = (
        <>
          ...
          <div>
            Over {instructorOrSpeakerXps} experiences as an instructor or speaker and {volunteerXps} volunteer positions around
            leadership, web development, community and the arts. See all of them at{' '}
      ...
      otherXps = (
        <>
          ...
          <p className='summary'>
            Volunteer work ignited in me the caring for people: be them the ones we are the doing the work for, or my colleagues.
            It also taught me to value and dedicate my time for something else than money, for something that would do (or be)
            good for someone besides myself.
          </p>
